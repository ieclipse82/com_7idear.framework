...
final class GridLayoutManagerOriginal
    ...
    public GridLayoutManagerOriginal(BaseGridView baseGridView) {
    ...
    final static class SavedState implements Parcelable {
        ...
        SavedState(Parcel in) {
            index = in.readInt();
            childStates = in.readBundle(GridLayoutManagerOriginal.class.getClassLoader());
        }
