 ...
 * @description
 */
public abstract class UIBaseFrameLayout
        extends FrameLayout
        implements IUIBase, IUIShowOrHide {

    private UIEntity mUIEntity; //UI信息对象

    public UIBaseFrameLayout(Context context) {
        this(context, null, 0);
    }

    public UIBaseFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UIBaseFrameLayout(Context context, AttributeSet attrs, int defStyle) {
